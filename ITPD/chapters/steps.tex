...
\begin{tabular} {| L{7cm} | L{7cm} |}
  \hline
  \multicolumn{2}{|c|}{manageWorker(data)} \\
  \hline
  \textit{Input} & \textit{Effect} \\
  \hline
  A null parameter & A NullArgumentException is raised \\
...
\begin{tabular} {| L{7cm} | L{7cm} |}
  \hline
  \multicolumn{2}{|c|}{getStatistics(data)} \\
  \hline
  \textit{Input} & \textit{Effect} \\
  \hline
  A null parameter & A NullArgumentException is raised \\
...
\begin{tabular} {| L{7cm} | L{7cm} |}
  \hline
  \multicolumn{2}{|c|}{changeMyState(data)} \\
  \hline
  \textit{Input} & \textit{Effect} \\
  \hline
  A null parameter & A NullArgumentException is raised \\
...
\begin{tabular} {| L{7cm} | L{7cm} |}
  \hline
  \multicolumn{2}{|c|}{updateTask(data)} \\
  \hline
  \textit{Input} & \textit{Effect} \\
  \hline
  A null parameter & A NullArgumentException is raised \\
...
\subsection{Router + AuthorizationManager, DriveManager}
...
\subsection{Router + AuthorizationManager, VehicleManager}
