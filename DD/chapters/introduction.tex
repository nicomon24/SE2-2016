...
\item [User Interface Design:] since the funcionalities contained in this Document and in the RASD are very explanatory for themselves, we do not include any further expansions of the UI design of the RASD. 
