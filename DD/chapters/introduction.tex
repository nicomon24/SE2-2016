...
\item \textbf{Component View:} more detailed view of the components of the application;
\item \textbf{Deploying View:} this section shows the execution architecture of the system representing the deployed software and hardware.
\item \textbf{Runtime View:} shows the behaviour and the workflow of the System during some typical situation;
\item \textbf{Component Interfaces:} describes the interfaces between the components.
\end{itemize}
\item [Algorithm Desing:] we will present some algorithms with pseudocode to show the locig of the most important parts of the System;
