...
\begin{center}
\includegraphics[width=18cm,height=18cm,keepaspectratio]{Registration}
\end{center}
\subsection{Reservation with Report}
\begin{center}
\includegraphics[width=18cm,height=18cm,keepaspectratio]{ReservationWithReport}
\end{center}

\newpage
\section{Class diagram}
\begin{center}
\includegraphics[width=18cm,height=18cm,keepaspectratio]{ClassDiagram}
\end{center}
